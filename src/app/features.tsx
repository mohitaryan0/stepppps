    ...
    <div className="bg-teal-dark dark:bg-teal-dark py-12">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <span
            className={`absolute text-5xl sm:text-5xl font-bold uppercase clip-top transition-transform duration-500 ${
              isSplit ? "-translate-y-3" : ""
            }`}
          >
          ...
          <span
            className={`absolute text-5xl sm:text-5xl font-bold uppercase clip-bottom transition-transform duration-500 ${
              isSplit ? "translate-y-3" : ""
            }`}
          >
            {featuresText.split("").map((char, index) => (
          ...
          <span
            className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 origin-center text-lg font-medium tracking-wide text-white dark:text-white px-6 py-2 rounded whitespace-nowrap ${
              isSplit ? "scale-y-100" : "scale-y-0"
            }`}
          >
              ...
              <div className="relative w-full">
                <PinContainer title={feature.title} href="#" className="w-full">
                  <div className="flex flex-col gap-4 p-4 w-64 h-80 text-sm text-white leading-relaxed rounded-xl">
                    <div className="flex-1">{feature.description}</div>
